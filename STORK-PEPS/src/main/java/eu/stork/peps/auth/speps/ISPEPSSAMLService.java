 ...
 */
public interface ISPEPSSAMLService {
     ...
     * @see Map
     */
    STORKAuthnRequest processAuthenticationRequest(byte[] samlToken,
     ...
     * @see STORKAuthnRequest
     */
    STORKAuthnRequest processAuthenticationResponse(byte[] samlToken,
                                                    STORKAuthnRequest authnData, STORKAuthnRequest spAuthnData,
                                                    String remoteAddr);
     ...
     * @see STORKAuthnRequest
     */
    STORKAuthnRequest generateSpAuthnRequest(STORKAuthnRequest authData);

    /**
     * Creates a SAML Authentication Request to send to C-PEPS.
     *
     * @param authData An authentication request.
     * @return A new authentication request with the SAML token embedded.
     * @see STORKAuthnRequest
     */
    STORKAuthnRequest generateCpepsAuthnRequest(STORKAuthnRequest authData);
     ...
     * @param parameters
     */
    void filterServiceSupportedAttrs(STORKAuthnRequest authData,Map<String, String> parameters);
}
