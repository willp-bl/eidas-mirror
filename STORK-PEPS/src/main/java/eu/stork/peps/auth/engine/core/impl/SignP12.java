...
public final class SignP12 extends AbstractSigner {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(eu.stork.peps.auth.engine.core.impl.SignP12.class);
    ...
    public SAMLObject validateSignature(SignableSAMLObject tokenSaml) throws SAMLEngineException {
