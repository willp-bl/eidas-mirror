 ...
 */
public class PEPSHttpMetadataProvider extends HTTPMetadataProvider {
    public PEPSHttpMetadataProvider(Timer t, HttpClient client, String url) throws MetadataProviderException {
        super(t, client, url);
    }
