 ...
 */
public class AUCPEPSSAMLTestCertif {
    ...
    public static void runBeforeClass() throws Exception {
        ...
        CONFIGS.setProperty(
                PEPSErrors.COLLEAGUE_REQ_INVALID_COUNTRYCODE.errorCode(), "002001");
        CONFIGS.setProperty(
...
//                "org.bouncycastle.crypto.digests.SHA512Digest");
    ...
    public void testProcessAuthenticationRequest() {
        ...
        final AUCPEPSSAML aucpepssaml = new AUCPEPSSAML();
        ...
        }catch(InternalErrorPEPSException exc){
            assertTrue(exc.getCause() instanceof STORKSAMLEngineException);
