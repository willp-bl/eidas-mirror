...
import eu.stork.peps.vc.VersionControl;
...
public final class Updater {
  ...
  private static final String RETURN_MSG = "Refresh operation launched";
    ...
    StorkSAMLEngineFactoryI pepsSamlEngineFactory;
  ...
  public VersionControl getVc() {
    ...
    public StorkSAMLEngineFactoryI getPepsSamlEngineFactory() {
        return pepsSamlEngineFactory;
    }

    public void setPepsSamlEngineFactory(StorkSAMLEngineFactoryI pepsSamEngineFactory) {
        this.pepsSamlEngineFactory = pepsSamEngineFactory;
    }
    ...
    private boolean isRefreshPossible(HttpServletRequest req){
        ...
        if(getPepsSamlEngineFactory().getActiveEngineCount(null)>0){
