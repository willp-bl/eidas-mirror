...
/**
 * This exception is thrown by the eIDAS Service service and holds the relative
...
public class EIDASServiceException extends AbstractEIDASException {
    ...
    public EIDASServiceException(final String code, final String message) {
     ...
     */
    public EIDASServiceException(final String samlToken, final String code,
    ...
    public EIDASServiceException(final String samlToken, final String code, final String message,
     ...
     */
    public EIDASServiceException(final String samlToken) {
        super(samlToken);
