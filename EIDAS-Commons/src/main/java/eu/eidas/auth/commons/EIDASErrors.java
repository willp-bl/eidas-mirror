...
/**
 * This enum class contains all the eIDAS Nodes, Commons and Specific errors
 * constant identifiers.
 *
 */
public enum EIDASErrors {
  ...
  MISSING_SESSION_ID("sessionError"),
    ...
    ;
    private static Map<String, EIDASErrors> errorsByCode =new HashMap<String, EIDASErrors>();
    private static Map<String, EIDASErrors> errorsByID =new HashMap<String, EIDASErrors>();
    static{
        for(EIDASErrors e:EIDASErrors.values()){
   ...
   */
  EIDASErrors(final String nError) {
    this.error = nError;
  }
  EIDASErrors(final String nError, final boolean showToUser) {
    this.error = nError;
  ...
  public String toString() {
    ...
    public static EIDASErrors fromCode(String code){
    ...
    public static boolean isErrorCode(String code) {
        return null != EIDASErrors.fromCode(code);
    }
    public static EIDASErrors fromID(String id){
        if(id!=null){
