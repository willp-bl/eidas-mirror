 ...
 * 
 */
public abstract class AbstractEIDASException extends RuntimeException implements
  Serializable {
   ...
   */
  public AbstractEIDASException(final String code, final String message) {
   ...
   */
  public AbstractEIDASException(final String message, final Throwable cause) {
  ...
  public AbstractEIDASException(final String code, final String message,
                               final Throwable cause, String userErrorCodeArg, String userErrorMessageArg) {
   ...
   * @param samlToken The error SAML Token.
   */
  public AbstractEIDASException(final String samlToken) {
    super();
    this.samlTokenFail = samlToken;
    userErrorCode=null;
    userErrorMessage=null;
