 ...
 */
public class InvalidParameterCPEPSException extends CPEPSException {
     ...
     */
    public InvalidParameterCPEPSException(final String errorCode,
     ...
     */
    public InvalidParameterCPEPSException(final String samlTokenFail) {
        super(samlTokenFail);
    }
