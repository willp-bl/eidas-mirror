    ...
    public static Properties loadPropertiesXMLFile(String xmlFilePath) {
        ...
        try{
            if(StringUtils.isEmpty(xmlFilePath) || !StringUtils.endsWith(xmlFilePath,"xml")){
                throw new InternalErrorPEPSException(PEPSErrors.INTERNAL_ERROR.errorCode(), PEPSErrors.INTERNAL_ERROR.errorMessage(),"Not valid file!");
            }else {
            ...
            throw new InternalErrorPEPSException(PEPSErrors.INTERNAL_ERROR.errorCode(), PEPSErrors.INTERNAL_ERROR.errorMessage(), e);
        }finally {
            try{
