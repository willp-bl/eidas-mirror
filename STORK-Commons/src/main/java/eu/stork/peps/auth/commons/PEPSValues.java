...
public enum PEPSValues {
  ...
  PEPS_METADATA_ACTIVE("metadata.activate"),
  PEPS_METADATA_CHECK_SIGNATURE("peps.metadata.check.signature"),
  ...
  SPEPS_SUPPORT_FRAMING_REQUEST("speps.supportFramingSamlRequest"),
