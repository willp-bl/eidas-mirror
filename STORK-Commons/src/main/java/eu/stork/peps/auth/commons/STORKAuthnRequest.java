...
public final class STORKAuthnRequest implements Serializable, Cloneable {
   ...
   * Logger object.
   */
  private static final Logger LOG = LoggerFactory.getLogger(STORKAuthnRequest.class
    .getName());
  ...
  public Object clone() throws CloneNotSupportedException{
    STORKAuthnRequest storkAuthnReq = null;
      ...
      try {
          ...
          storkAuthnReq.setMessageFormatName(messageFormatName);
          storkAuthnReq.setSPType(getSPType());
    ...
    /**
     * Returns the string representation of a STORKAuthnRequest
