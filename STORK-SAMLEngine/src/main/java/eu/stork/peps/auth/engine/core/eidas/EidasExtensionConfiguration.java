...
import eu.stork.peps.auth.engine.core.eidas.impl.*;
import eu.stork.peps.auth.engine.core.eidas.impl.RequestedAttributeBuilder;
import eu.stork.peps.auth.engine.core.eidas.impl.RequestedAttributeMarshaller;
import eu.stork.peps.auth.engine.core.eidas.impl.RequestedAttributeUnmarshaller;
import eu.stork.peps.auth.engine.core.eidas.impl.RequestedAttributesBuilder;
import eu.stork.peps.auth.engine.core.eidas.impl.RequestedAttributesMarshaller;
import eu.stork.peps.auth.engine.core.eidas.impl.RequestedAttributesUnmarshaller;
import eu.stork.peps.auth.engine.core.eidas.impl.SPCountryMarshaller;
import eu.stork.peps.auth.engine.core.eidas.impl.SPCountryUnmarshaller;
...
public class EidasExtensionConfiguration {
    public void configureExtension(){
        ...
        for(String attrName: EIDASAttributes.ATTRIBUTES_SET_TYPES.values()){
