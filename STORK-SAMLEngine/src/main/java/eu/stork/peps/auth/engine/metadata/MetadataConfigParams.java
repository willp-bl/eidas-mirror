...
public class MetadataConfigParams {
    ...
    String countryName;
    String nodeUrl;
    STORKSAMLEngine idpEngine;
    STORKSAMLEngine spEngine;
    ...
    public STORKSAMLEngine getIdpEngine() {
        return idpEngine;
    }

    public void setIdpEngine(STORKSAMLEngine idpEngine) {
        this.idpEngine = idpEngine;
    }

    public STORKSAMLEngine getSpEngine() {
        return spEngine;
    }

    public void setSpEngine(STORKSAMLEngine spEngine) {
