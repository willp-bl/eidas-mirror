...
import eu.stork.peps.auth.engine.core.eidas.RequestedAttribute;
...
public class EidasRequestedAttributeValidator extends
    ...
    public void validate(RequestedAttribute attr) throws ValidationException {
        ...
        /*if (!eu.stork.peps.auth.engine.core.validator.eidas.EIDASAttributes.ATTRIBUTES_SET.containsKey(attr.getName()) && !attr.isRequired().isEmpty() && "true".equals(attr.isRequired())) {
