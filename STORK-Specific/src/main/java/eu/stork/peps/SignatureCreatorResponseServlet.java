  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    try {
      ...
      final String createXMLSignatureResponse =
              request.getParameter(PEPSParameters.XML_RESPONSE.toString());
      ...
      if ( !StringUtilities.isEmpty(createXMLSignatureResponse)) {
        ...
        sigCreatorResp.getSession().put(PEPSParameters.SIGNATURE_RESPONSE.toString(), values);
      } else {
