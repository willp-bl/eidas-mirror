...
/**
 * Specific class that implements the {@link IStorkLogger}.
 *
 * @author ricardo.ferreira@multicert.com, renato.portela@multicert.com,
 *         luis.felix@multicert.com, hugo.magalhaes@multicert.com
 */
public final class StorkLoggerBean implements IStorkLogger {
    /**
     * The origin.
     */
    ...
    public String toString() {
        ...
        stringBuilder.append("OpType        ").append(timestamp).append(",\n");

        if (PEPSValues.SPEPS_REQUEST.toString().equals(opType) ||
                PEPSValues.CPEPS_REQUEST.toString().equals(opType) ||
                PEPSValues.SP_REQUEST.toString().equals(opType)) {
            ...
            if (PEPSValues.SPEPS_RESPONSE.toString().equals(opType)) {
